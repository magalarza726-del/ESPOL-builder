...
import { installForestRuntime } from './forest-runtime-v012.js';
...
export async function createGameWorld(options) {
  ...
  // Order matters: all later systems must read the exact same piecewise-planar
  // terrain surface that is visible on screen.
  installTerrainSurface(world);
  installForestRuntime(world);
