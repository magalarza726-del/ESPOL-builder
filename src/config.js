export const CAMPUS = {
  bounds: {north:-2.1311111111,south:-2.1569444444,east:-79.9425,west:-79.9825},
  spawn:{lng:-79.96792,lat:-2.14502},spawnBearing:71,spawnName:'Exterior del Auditorio FIEC',
  studyAreaHa:696,officialCampusAreaM2:6587827,officialForestAreaM2:5264107,officialBuildingAreaM2:174902,officialForestCoverage:.80,officialPlantedVegetationMax:.10,
  routesKm:22.9831,roadWidthThresholdM:1.8,
  avatarHeightM:1.80,eyeHeightM:1.68,playerRadiusM:.38,jogSpeedMps:2.6,sprintMultiplier:2.5,thirdPersonDistanceM:6.5,thirdPersonCameraHeightM:2.9,
  movementSubstepM:.75,inputResponsiveness:19,turnResponsiveness:17,turnSpeedDegS:120,accelerationMps2:34,brakingMps2:46,hudIntervalMs:100,landmarkIntervalMs:280
};
...
export const LANDMARKS = [
  ...
  {id:'lake',name:'Lago / Embalse ESPOL',lng:-79.96160,lat:-2.14730,category:'Paisaje',note:'Embalse del campus.'}
];

export const BUILDING_CATALOG = [
  {faculty:'FIEC',blocks:'11A, 11B, 11C, 11D, 11F',detail:'11A es el edificio principal y contiene administración y Auditorio FIEC; 11B soporte/aulas híbridas/computación; 11C laboratorios eléctricos, electrónicos, telecom y control; 11D aulas/asociaciones; 11F oficinas y clubes.'},
  ...
  {faculty:'FADCOM',blocks:'14A, 14B, 14C, 3M, 7B',detail:'14A/14B administración, aulas, laboratorios y talleres; 14C comedor/parqueadero; 3M talleres; 7B Motion Lab.'},
  {faculty:'FCV',blocks:'sector FCV + Centro de Interpretación BVPP',detail:'Facultad ligada a laboratorios de ciencias de la vida, vivero y restauración del Bosque Protector.'},
  {faculty:'FCNM',blocks:'sector FCNM',detail:'Bloques de matemáticas/ciencias naturales, aulas y laboratorios.'},
  {faculty:'FCSH',blocks:'sector FCSH',detail:'Bloques de Ciencias Sociales y Humanísticas.'},
  {faculty:'CIB',blocks:'7A',detail:'Biblioteca/Centro de Información Bibliotecaria, frente a Rectorado.'}
];

// IVI (%) publicados por Adriano Macas (ESPOL 2024/2025).
export const ECOLOGICAL_PLOTS = [
  {id:'low',label:'Bosque · parcela baja',lng:-79.9735866,lat:-2.1449699,altitudeM:125,species:[
    ['Handroanthus chrysanthus',34.72],['Cochlospermum vitifolium',31.93],['Machaerium millei',14.07],['Gliricidia brenningii',7.88],['Centrolobium ochroxylum',6.67],['Pseudalbizzia multiflora',3.37],['Randia armata',.79],['Morisonia flexuosa',.58]
  ]},
  {id:'mid',label:'Bosque · parcela media',lng:-79.9738972,lat:-2.1477584,altitudeM:179,species:[
    ['Machaerium millei',43.88],['Cochlospermum vitifolium',17.22],['Gliricidia brenningii',9.99],['Simira ecuadorensis',9.90],['Gliricidia sepium',6.25],['Handroanthus chrysanthus',2.75],['Pseudalbizzia multiflora',2.62],['Guazuma ulmifolia',2.48],['Eriotheca ruizii',2.24],['Randia armata',1.29],['Sapindus saponaria',.76],['Morisonia flexuosa',.63]
  ]},
  {id:'high',label:'Bosque · parcela alta',lng:-79.9784023,lat:-2.1506086,altitudeM:226,species:[
    ['Ficus insipida',32.29],['Simira ecuadorensis',16.68],['Sorocea sprucei',12.01],['Eugenia concava',9.45],['Neea divaricata',8.12],['Cynometra bauhiniifolia',7.38],['Myrcia splendens',3.42],['Guarea glabra',3.09],['Trichilia elegans',2.74],['Triplaris cumingiana',1.75],['Bauhinia aculeata',1.08],['Gustavia angustifolia',1.02],['Pseudobombax millei',.96]
  ]}
];
...
export const TREE_SPECIES = [
  ...
  {name:'Pseudalbizzia multiflora',scientific:'Pseudalbizzia multiflora',maxHeight:22,deciduous:true,weight:.34,context:'native',form:'umbrella'},
  ...
  {name:'Guazuma ulmifolia',scientific:'Guazuma ulmifolia',maxHeight:20,deciduous:true,weight:.26,context:'native',form:'round'},
  {name:'Eriotheca ruizii',scientific:'Eriotheca ruizii',maxHeight:25,deciduous:true,weight:.22,context:'native',form:'ceibo'},
  {name:'Sapindus saponaria',scientific:'Sapindus saponaria',maxHeight:18,deciduous:false,weight:.16,context:'native',form:'round'},
  ...
  {name:'Cynometra bauhiniifolia',scientific:'Cynometra bauhiniifolia',maxHeight:24,deciduous:false,weight:.28,context:'native',form:'round'},
  {name:'Myrcia splendens',scientific:'Myrcia splendens',maxHeight:18,deciduous:false,weight:.18,context:'native',form:'round'},
  {name:'Guarea glabra',scientific:'Guarea glabra',maxHeight:24,deciduous:false,weight:.18,context:'native',form:'round'},
  {name:'Trichilia elegans',scientific:'Trichilia elegans',maxHeight:18,deciduous:false,weight:.15,context:'native',form:'round'},
  {name:'Triplaris cumingiana',scientific:'Triplaris cumingiana',maxHeight:22,deciduous:true,weight:.13,context:'native',form:'open'},
  {name:'Gustavia angustifolia',scientific:'Gustavia angustifolia',maxHeight:18,deciduous:false,weight:.12,context:'native',form:'round'},
  {name:'Pseudobombax millei',scientific:'Pseudobombax millei',maxHeight:28,deciduous:true,weight:.12,context:'native',form:'ceibo'},
  ...
  {name:'Randia',scientific:'Randia armata',maxHeight:7,deciduous:true,weight:.22,context:'native',form:'open'},
  {name:'Morisonia',scientific:'Morisonia flexuosa',maxHeight:7,deciduous:true,weight:.18,context:'native',form:'open'},
  {name:'Bauhinia',scientific:'Bauhinia aculeata',maxHeight:8,deciduous:true,weight:.16,context:'native',form:'open'},
